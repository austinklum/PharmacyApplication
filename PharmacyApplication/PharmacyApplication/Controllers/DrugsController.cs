...
namespace PharmacyApplication.Controllers
{
    public class DrugsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MedicalName,Type,Stock,CostPer,RecommendedDose")] Drug drug)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MedicalName,Type,Stock,CostPer,RecommendedDose")] Drug drug)
        {
            if (id != drug.Id)
            {
                return NotFound();
